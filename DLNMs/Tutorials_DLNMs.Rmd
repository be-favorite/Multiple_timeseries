...
## **1 Preparing**
***
먼저 분석에 필요한 여러가지 패키지를 불러오겠습니다. DLNMs의 적합에 필요한 {dlnm}, {splines} 패키지를 제외한, 나머지 두 패키지 {tidyverse}는 data wragling, {stringr}은 문자열 handling, {lubridate}는 날짜를 다루기 위해 불러왔습니다. {lubridate}가 {base}의 날짜 함수들보다 훨씬 직관적이므로, 배워둘만한 가치가 있습니다(see, `vignette("lubridate", package = "lubridate")`). `r emo::ji("blush")`
